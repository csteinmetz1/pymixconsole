...
class Compressor(Processor):
    ...
    def __init__(self, name="Compressor", block_size=512, sample_rate=44100):
        ...
        self.parameters.add(Parameter("attack_time",    2.0, "float", units="ms", processor=self, minimum=0.01,  maximum=100.0))
        self.parameters.add(Parameter("release_time",  50.0, "float", units="ms", processor=self, minimum=10.0,  maximum=1000.0))
